              ...
              <div class="row">
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" placeholder="Full Name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <textarea class="form-control input-lg" rows="4" placeholder="Brief intro about yourself"></textarea>
                  </div>
                  <div class="form-group checkbox">
                    <label><input type="checkbox" checked=""> Profile Active (Visible/Hidden)</label>
                  </div>
                  <div class="form-group checkbox">
                    <label><input type="checkbox"> Job Alerts</label>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" placeholder="Confirm Password">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <textarea class="form-control input-lg" rows="4" placeholder="Enter Skills"></textarea>
                  </div>
                  <div class="form-group">
                    <button class="btn btn-flat btn-danger">Attach Resume</button>
                  </div>
                </div>
              </div>
            </form>
